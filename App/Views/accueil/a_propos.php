...
<p><b> est une application qui à pour but d’offrir du service à la personne.</b></p>
		<p>En effet, tout le monde peut réserver une prestation de service qui sera effectué à l’adresse indiqué, le prestataire se déplace. Vous pouvez simplement réserver différentes prestations comme :</p>
			<ul>
				...
				<li>Faire du ménage</li>
				<li>Faire du repassage</li>
				<li>Débarrasser votre logement de choses qui vous encombre</li>
				<li>Un coup de mou? On cuisine pour vous</li>
			</ul>
